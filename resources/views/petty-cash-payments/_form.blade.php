...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header"><h5 class="card-title mb-0"><i class="ti ti-receipt me-1"></i>Data Pembayaran</h5></div>
            <div class="card-body">
                <div class="row g-3">
                    @if(! $lockRequest)
                        <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="payment_date" class="form-control" required
                               value="{{ old('payment_date', optional($p?->payment_date)->format('Y-m-d') ?: now()->toDateString()) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Jenis Biaya <span class="text-danger">*</span></label>
                        <select name="expense_category_id" class="form-select select2" required>
                    ...
                    <div class="col-md-12">
                        <label class="form-label">Uraian Pembayaran <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-12">
                        <label class="form-label">File Lampiran (Kwitansi / Bukti)</label>
                        @if($isEdit && $p->attachment_path)
                            <div class="mb-1 small">
                                <a href="{{ route('petty-cash-payments.attachment', $p->uid) }}" target="_blank" class="link-primary">
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <button type="submit" class="btn btn-primary w-100"><i class="ti ti-device-floppy me-1"></i>{{ $isEdit ? 'Simpan Perubahan' : 'Simpan Pembayaran' }}</button>
                <a href="{{ $isEdit ? route('petty-cash-payments.show', $p->uid) : route('petty-cash-payments.index') }}" class="btn btn-outline-secondary w-100 mt-2">Batal</a>
            </div>
        </div>
    </div>
</div>
