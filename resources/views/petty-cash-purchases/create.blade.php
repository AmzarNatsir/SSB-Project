...
@section('title', 'Buat Pembelian Tunai')
@section('content')
<div class="page-wrapper">
    <div class="content">
        <div class="d-md-flex d-block align-items-center justify-content-between mb-4">
            <div class="my-auto mb-2">
                <h3 class="page-title mb-1">Buat Pembelian Tunai</h3>
                <nav class="mt-1">
        ...
        @else
        <form action="{{ route('petty-cash-purchases.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @include('petty-cash-purchases._form', ['pettyCashPurchase' => null])
        </form>
        @endif
    </div>
</div>
