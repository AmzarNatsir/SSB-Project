        ...
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                <div class="my-auto mb-2">
                    <h3 class="page-title mb-1">Edit Scoring Plan Project</h3>
                    <nav>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body bg-light-50">
                            <form action="{{ route('scoring-plan-project.update', $criteria->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <!-- Header Form -->
                                <div class="card mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="name" class="form-control" value="{{ old('name', $criteria->name) }}" placeholder="Contoh: Profil Calon User" required>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="weighting" class="form-control numeric-input" value="{{ old('weighting', $criteria->weighting) }}" placeholder="Contoh: 8" required>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered mb-0" id="options-table">
                                                ...
                                                <tbody>
                                                    @php 
                                                        $oldOptions = old('options', $criteria->options->toArray()); 
                                                    @endphp
