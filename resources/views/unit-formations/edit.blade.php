...
@section('title', 'Edit SK Penetapan Unit')
@section('content')
<div class="page-wrapper">
    <div class="content">
            ...
            <div class="my-auto mb-2">
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('unit-formations.show', $formation->uid) }}">{{ $formation->formation_number }}</a></li>
        ...
        <div class="card">
            <div class="card-body">
                @include('unit-formations._form', ['projects' => $projects, 'formation' => $formation])
            </div>
        </div>
    </div>
</div>
