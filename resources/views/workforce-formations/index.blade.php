...
@section('title', 'SK Penugasan Tim')
@section('content')
    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between mb-4">
            <div class="my-auto mb-2">
                <h3 class="page-title mb-1">SK Penugasan Tim</h3>
                <p class="text-muted mb-0 small">Penetapan anggota tim/personel lapangan per proyek (period-based, multi-level approval).</p>
                <nav class="mt-1">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active">SK Penugasan Tim</li>
                    </ol>
                </nav>
            </div>
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
                <a href="{{ route('workforce-formations.create') }}" class="btn btn-primary btn-label">
        ...
        <div class="row">
            @php
                $kpis = [
                    ['label' => 'Total SK',         'value' => $stats['total'],     'icon' => 'ti-users-group',      'class' => 'primary'],
                        ...
                        <form method="GET" class="row g-2 align-items-center">
                            ...
                            <div class="col-md-3">
                                <select name="status" class="form-select">
                                    ...
                                    @foreach(\App\Enums\WorkforceFormationStatus::cases() as $st)
                            ...
                            <div class="col-md-auto">
                                ...
                                <a href="{{ route('workforce-formations.index') }}" class="btn btn-outline-secondary">Reset</a>
                            </div>
                        </form>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive table-card">
                            <table class="table table-nowrap align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('workforce-formations.show', $f->uid) }}" class="fw-medium link-primary">
                                                {{ $f->formation_number }}
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('workforce-formations.show', $f->uid) }}">
                                                            <i class="ti ti-eye me-2 text-muted"></i> Lihat Detail
                                                        </a>
                                                    </li>
                                                    @if($f->canEdit())
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('workforce-formations.edit', $f->uid) }}">
                                    ...
                                    <tr>
                                        <td colspan="8" class="text-center py-5">
                                            ...
                                            <h5>Belum ada SK Penugasan Tim</h5>
                                            <p class="text-muted">Buat SK dari proyek yang memiliki kontrak AKTIF.</p>
                                            <a href="{{ route('workforce-formations.create') }}" class="btn btn-primary btn-sm">
